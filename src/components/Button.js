...
const useStyles = makeStyles({
  ...
  primary: {
    ...
    background:
      "linear-gradient(267.26deg, #E56900 1.85%, #FF7500 53.45%, #FFC063 109.55%);",
    boxShadow:
      "0 2px 2px 0 rgba(229, 105, 0, 0.14), 0 3px 1px -2px rgba(229, 105, 0, 0.2), 0 1px 5px 0 rgba(229, 105, 0, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: "#FF7500",
      background:
        "linear-gradient(267.26deg, #F67000 1.85%, #FF953C 53.45%, #FFC266 109.56%);",
      boxShadow:
  ...
  secondary: {
    ...
    background:
      "linear-gradient(267.26deg, #7D5CFF 0%, #679AFD 48.44%, #00BAFF 100%);",
    boxShadow:
    ...
    "&:hover,&:focus": {
      ...
      background:
        "linear-gradient(267.26deg, #8F73FF 0%, #83ADFF 48.44%, #5BD3FF 100%);",
      boxShadow:
